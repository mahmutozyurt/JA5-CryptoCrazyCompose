package com.mtoz147.ja5_cryptocrazycompose.view
...
import com.mtoz147.ja5_cryptocrazycompose.viewmodel.CryptoListViewModel
...
@Composable
fun CryptoListView(
    cryptos: List<CryptoListItem>,navController: NavController
){
